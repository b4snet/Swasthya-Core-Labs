...
- Publishing others' private information (including clinical data) without
  explicit permission
...
reported to the maintainers via the repository maintainers. Enforcement
responses will be consistent with the standards above.
