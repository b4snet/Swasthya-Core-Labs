...
public sealed class CodeSystem
{
        ...
        string? description = null)
    {
        ...
        CanonicalUrl = (canonicalUrl ?? string.Empty).Trim();
    ...
    public bool VersionRequired { get; private set; }
    ...
    public void Update(string name, string? canonicalUrl, bool versionRequired, string? description = null)
    {
        Name = CatalogCodes.RequireName(name, nameof(name));
        CanonicalUrl = (canonicalUrl ?? string.Empty).Trim();
        VersionRequired = versionRequired;
