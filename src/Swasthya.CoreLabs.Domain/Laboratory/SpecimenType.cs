...
public sealed class SpecimenType
{
    private SpecimenType()
    {
    }

    public SpecimenType(Guid organizationId, string code, string name, string? description = null)
    {
        Id = Guid.NewGuid();
...
public sealed class SpecimenSource
{
    private SpecimenSource()
    {
    }

    public SpecimenSource(Guid organizationId, string code, string name, string? description = null)
    {
        Id = Guid.NewGuid();
        OrganizationId = organizationId;
        Code = CatalogCodes.RequireCode(code, nameof(code));
